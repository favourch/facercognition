...
<body>
  <nav class="light-blue lighten-1" role="navigation">
   ...
   <div class="section no-pad-bot" id="index-banner">
    <div class="container">
      <br><br>
      <h1 class="header center orange-text">Recognize Image</h1>
    ...
    <div class="form-group">
            ...
            <input type="text" class="form-control" name="studentId" id="studentId1" placeholder="It can be use later on facerecognition." required="required" required="required">
